//Ejercicio5- Crear una Clase llamada CuentaBancaria que tenga las propiedades
//titular y saldo e implementar depositar, retirar, consultar saldo
  ...
  void retirar(double cantidad) {
    if (cantidad > 0) {
      if (cantidad <= saldo) {
        saldo -= cantidad;
        print(
          'Se ha realizado su retiro correctamente, su saldo actual es:$saldo',
        );
      } else {
